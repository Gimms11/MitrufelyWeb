...
const rawProducts: Omit<Producto, 'disponible'>[] = [
  {
    ...
    categoria_nombre: 'Trufa Clásica',
    rating: 4.9,
    consideraciones_almacenamiento: 'Conservar en lugar fresco y seco entre 15°C y 18°C. No refrigerar. Consumir antes de los 7 días de elaboración.',
    tiempo_vida_dias: 7,
  },
  {
    id_producto: 2,
    ...
    categoria_nombre: 'Trufa Clásica',
    rating: 4.7,
    consideraciones_almacenamiento: 'Mantener alejada de fuentes de calor. Ideal entre 15°C y 18°C. No exponer a luz solar directa. Consumir en 5 días.',
    tiempo_vida_dias: 5,
  },
  {
    id_producto: 3,
    ...
    categoria_nombre: 'Trufa Clásica',
    rating: 4.8,
    consideraciones_almacenamiento: 'Almacenar en recipiente hermético a temperatura ambiente. Evitar humedad. Vida útil: 7 días.',
    tiempo_vida_dias: 7,
  },
  {
    id_producto: 4,
    ...
    categoria_nombre: 'Trufa Clásica',
    rating: 4.6,
    consideraciones_almacenamiento: 'Refrigerar si la temperatura ambiente supera los 22°C. Consumir en los primeros 5 días para disfrutar el sabor óptimo a la frambuesa.',
    tiempo_vida_dias: 5,
  },
  {
    id_producto: 5,
    ...
    fecha_actualizacion: '2025-06-01T08:30:00Z',
    categoria_nombre: 'Sin Azúcar',
    rating: 4.5,
    consideraciones_almacenamiento: 'Conservar en lugar fresco y seco. Apta para diabéticos bajo supervisión médica. Consumir en 10 días.',
    tiempo_vida_dias: 10,
  },
  {
    id_producto: 6,
    ...
    categoria_nombre: 'Sin Azúcar',
    rating: 4.4,
    consideraciones_almacenamiento: 'Sin alérgenos declarados. Almacenar a temperatura ambiente en recipiente sellado. Vida útil: 10 días.',
    tiempo_vida_dias: 10,
  },
  {
    id_producto: 7,
    ...
    rating: 4.9,
    consideraciones_almacenamiento: 'Mantener en lugar fresco, oscuro y seco. Temperatura ideal 16°C. No mezclar con productos de fuerte aroma. Consumir en 7 días.',
    tiempo_vida_dias: 7,
  },
  {
    id_producto: 8,
    ...
    categoria_nombre: 'Trufa Clásica',
    rating: 4.5,
    consideraciones_almacenamiento: 'Almacenar alejada de otros productos para evitar transferencia de aroma. Temperatura ambiente. Consumir en 7 días.',
    tiempo_vida_dias: 7,
  },
  {
    id_producto: 9,
    ...
    categoria_nombre: 'Trufa Clásica',
    rating: 4.7,
    consideraciones_almacenamiento: 'El contenido de sal fleur de sel puede cristalizarse con la humedad. Conservar en recipiente hermético. Vida útil: 7 días.',
    tiempo_vida_dias: 7,
  },
  {
    id_producto: 10,
    ...
    fecha_actualizacion: '2025-06-01T08:30:00Z',
    categoria_nombre: 'Ocasiones Especiales',
    rating: 5.0,
    consideraciones_almacenamiento: 'Edición limitada decorada a mano. No refrigerar para preservar los detalles decorativos. Consumir en los primeros 5 días.',
    tiempo_vida_dias: 5,
  },
  {
    id_producto: 11,
    ...
    categoria_nombre: 'Trufa Clásica',
    rating: 4.8,
    consideraciones_almacenamiento: 'Almacenar en lugar fresco. Los trozos de avellana pueden perder crocancia con humedad excesiva. Consumir en 7 días.',
    tiempo_vida_dias: 7,
  },
  {
    id_producto: 12,
    ...
    categoria_nombre: 'Sin Azúcar',
    rating: 4.6,
    consideraciones_almacenamiento: 'Contiene maní. Almacenar en recipiente hermético lejos de alérgenos cruzados. Vida útil: 10 días a temperatura ambiente.',
    tiempo_vida_dias: 10,
  },
  {
    id_producto: 13,
    ...
    categoria_nombre: 'Trufa Clásica',
    rating: 4.3,
    consideraciones_almacenamiento: 'Mantener refrigerado si hace calor. El zest de limón puede intensificarse con el tiempo. Consumir en 5 días.',
    tiempo_vida_dias: 5,
  },
  {
    id_producto: 14,
    ...
    categoria_nombre: 'Especiales',
    rating: 4.9,
    consideraciones_almacenamiento: 'Contiene sulfitos (alcohol). No apto para menores de edad. Almacenar en lugar oscuro y fresco. Consumir en 7 días.',
    tiempo_vida_dias: 7,
  },
  {
    id_producto: 15,
    ...
    categoria_nombre: 'Ocasiones Especiales',
    rating: 4.7,
    consideraciones_almacenamiento: 'Decoración comestible frágil. Manejar con cuidado. Conservar en caja original. Consumir antes de 7 días.',
    tiempo_vida_dias: 7,
  },
  {
    id_producto: 16,
    ...
    categoria_nombre: 'Sin Azúcar',
    rating: 4.5,
    consideraciones_almacenamiento: 'Sin lactosa. Ideal para intolerantes a la lactosa. Almacenar en lugar fresco. Vida útil: 10 días.',
    tiempo_vida_dias: 10,
  },
  {
    id_producto: 17,
    ...
    categoria_nombre: 'Trufa Clásica',
    rating: 4.8,
    consideraciones_almacenamiento: 'Contiene gluten y huevo. No apta para celíacos. Almacenar en recipiente hermético. Consumir en 7 días para disfrutar la textura del brownie.',
    tiempo_vida_dias: 7,
  },
  {
    id_producto: 18,
    ...
    categoria_nombre: 'Especiales',
    rating: 4.9,
    consideraciones_almacenamiento: 'El matcha es sensible a la luz UV. Mantener en caja oscura. Temperatura entre 14°C-18°C. Consumir en 7 días.',
    tiempo_vida_dias: 7,
  },
  {
    id_producto: 19,
    ...
    categoria_nombre: 'Ocasiones Especiales',
    rating: 5.0,
    consideraciones_almacenamiento: 'Personalización hecha a mano. Manejar con extremo cuidado. No apilar. Consumir máximo 5 días después de elaboración.',
    tiempo_vida_dias: 5,
  },
  {
    id_producto: 20,
    ...
    categoria_nombre: 'Trufa Clásica',
    rating: 4.7,
    consideraciones_almacenamiento: 'Contiene alcohol. No apto para menores de edad ni embarazadas. Almacenar a temperatura ambiente lejos del calor. Consumir en 7 días.',
    tiempo_vida_dias: 7,
  },
]
