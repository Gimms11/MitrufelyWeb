...
class EmailService:
    ...
    @staticmethod
    def _send_smtp_verification(to_email: str, token: str, user_name: str) -> None:
        ...
        msg["Subject"] = "🧁 ¡Verifica tu cuenta en Mitrufely Web!"
        msg["From"] = settings.SMTP_FROM or settings.SMTP_USER
        msg["To"] = to_email

        # Build verification URL pointing to the Frontend React application
        frontend_url = settings.FRONTEND_URL
        verification_link = f"{frontend_url}/verify?token={token}"

        # Log verification link to standard out for easy local copy-paste development
        logger.info("email.verification_link_generated", link=verification_link)
